...
{
    public class AchievementModel : IEquatable<AchievementModel>
    {
        /// <summary>
        /// Gets or sets the id.
        /// </summary>
        ...
        /// </returns>
        public bool Equals(AchievementModel other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof (AchievementModel))
            {
                return false;
            }
            return Equals((AchievementModel) obj);
        }
