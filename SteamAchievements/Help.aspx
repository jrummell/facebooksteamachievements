...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <p>
        On the Steam Achievements application page, complete your Custom URL and hit Update.<br />
        <img src="images/appcustomurl.png" alt="http://steamcommunity.com/id/[custom url suffix]" />
    </p>
    <p>
        Update your achievements by clicking the Update link in the Achievements box. This
        will find all of your Steam achievements for the supported games. It will also post
        that last five achievements that you earned to your profile:</p>
    <p>
        <img alt="" src="images/achievements.png" /></p>
    <p>
    ...
    <p>
        <a href="">Back to Steam Achievements</a></p>
</asp:Content>
