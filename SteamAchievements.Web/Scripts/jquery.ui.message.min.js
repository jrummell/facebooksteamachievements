//jquery.ui.message 1.7.2. Copyright (c) 2011 John Rummell (jrummell.com). Licensed under the GPL license  (http://www.gnu.org/licenses/gpl.html). 
...
{jQuery.error("Method "+method+" does not exist on jQuery.message");}};jQuery.fn.message.defaults={message:"",type:"info",dismiss:true,autoShow:true};})(jQuery);